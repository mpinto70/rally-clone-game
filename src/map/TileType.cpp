...
std::string to_string(TileType enum_value) {
    switch (enum_value) {
        ...
        CASE_ENUM_TO_STRING(TileType::TOP_LEFT_RIGHT_BOTTOM);
        ...
        CASE_ENUM_TO_STRING(TileType::SE_NE);
        ...
        CASE_ENUM_TO_STRING(TileType::SE_NE_NW);
        CASE_ENUM_TO_STRING(TileType::SW_SE_NE);
