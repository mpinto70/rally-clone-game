...
public:
     ...
     */
    Tile& operator()(map_dimension_t x, map_dimension_t y) { return tiles_[y * width_ + x]; }
    /** return the tile at column \b x and line \b y.
     * @param x the horizontal coordinate of the tile
     * @param y the vertical coordinate of the tile
     */
    const Tile& operator()(map_dimension_t x, map_dimension_t y) const { return tiles_[y * width_ + x]; }
