...
void testCMap::testCreation() {
    ...
    const CMap m2(2, 3, 7, tiles);
    TS_ASSERT_EQUALS(m2.width(), 2u);
    TS_ASSERT_EQUALS(m2.height(), 3u);
    TS_ASSERT_EQUALS(m2.parts(), 7u);
    TS_ASSERT_EQUALS(m2.tiles(), tiles);
}

void testCMap::testInvalidCreation() {
    TS_ASSERT_THROWS_EQUALS(CMap(0, 2, 3, { CTile{ ETileType::ROAD, EAction::STONE } , CTile{ ETileType::BUSH, EAction::NONE} }),
                            std::invalid_argument & e,
                            std::string(e.what()),
                            "CMap - zero width");

    TS_ASSERT_THROWS_EQUALS(CMap(1, 0, 3, { CTile{ ETileType::ROAD, EAction::STONE } , CTile{ ETileType::BUSH, EAction::NONE} }),
                            std::invalid_argument & e,
                            std::string(e.what()),
                            "CMap - zero height");

    TS_ASSERT_THROWS_EQUALS(CMap(1, 2, 0, { CTile{ ETileType::ROAD, EAction::STONE } , CTile{ ETileType::BUSH, EAction::NONE} }),
                            std::invalid_argument & e,
                            std::string(e.what()),
                            "CMap - zero parts");

    TS_ASSERT_THROWS_EQUALS(CMap(1, 3, 3, { CTile{ ETileType::ROAD, EAction::STONE } , CTile{ ETileType::BUSH, EAction::NONE} }),
                            std::invalid_argument & e,
                            std::string(e.what()),
